 ...
 */
class getProductActionRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 5).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProductActionRepository.php';

        return $container->privates['App\\Repository\\ProductActionRepository'] = new \App\Repository\ProductActionRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
