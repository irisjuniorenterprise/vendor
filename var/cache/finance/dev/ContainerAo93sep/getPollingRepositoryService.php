 ...
 */
class getPollingRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PollingRepository' shared autowired service.
     *
     * @return \App\Repository\PollingRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 5).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PollingRepository.php';

        return $container->privates['App\\Repository\\PollingRepository'] = new \App\Repository\PollingRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
