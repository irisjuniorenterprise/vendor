...
class getAnnouncementRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 5).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AnnouncementRepository.php';

        return $container->privates['App\\Repository\\AnnouncementRepository'] = new \App\Repository\AnnouncementRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
