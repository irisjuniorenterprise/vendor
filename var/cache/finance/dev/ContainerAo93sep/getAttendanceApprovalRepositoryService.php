 ...
 */
class getAttendanceApprovalRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AttendanceApprovalRepository' shared autowired service.
     *
     * @return \App\Repository\AttendanceApprovalRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 5).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AttendanceApprovalRepository.php';

        return $container->privates['App\\Repository\\AttendanceApprovalRepository'] = new \App\Repository\AttendanceApprovalRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
