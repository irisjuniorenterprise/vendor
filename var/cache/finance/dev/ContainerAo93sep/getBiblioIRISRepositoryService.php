 ...
 */
class getBiblioIRISRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BiblioIRISRepository' shared autowired service.
     *
     * @return \App\Repository\BiblioIRISRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 5).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BiblioIRISRepository.php';

        return $container->privates['App\\Repository\\BiblioIRISRepository'] = new \App\Repository\BiblioIRISRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
