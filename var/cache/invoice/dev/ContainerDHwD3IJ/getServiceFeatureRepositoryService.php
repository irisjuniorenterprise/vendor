 ...
 */
class getServiceFeatureRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ServiceFeatureRepository' shared autowired service.
     *
     * @return \App\Repository\ServiceFeatureRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 5).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ServiceFeatureRepository.php';

        return $container->privates['App\\Repository\\ServiceFeatureRepository'] = new \App\Repository\ServiceFeatureRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
