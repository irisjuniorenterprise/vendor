 ...
 */
class getPriceProposalFeatureRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PriceProposalFeatureRepository' shared autowired service.
     *
     * @return \App\Repository\PriceProposalFeatureRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 5).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PriceProposalFeatureRepository.php';

        return $container->privates['App\\Repository\\PriceProposalFeatureRepository'] = new \App\Repository\PriceProposalFeatureRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
