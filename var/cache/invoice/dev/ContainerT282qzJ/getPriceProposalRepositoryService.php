 ...
 */
class getPriceProposalRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PriceProposalRepository' shared autowired service.
     *
     * @return \App\Repository\PriceProposalRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 5).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PriceProposalRepository.php';

        return $container->privates['App\\Repository\\PriceProposalRepository'] = new \App\Repository\PriceProposalRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
