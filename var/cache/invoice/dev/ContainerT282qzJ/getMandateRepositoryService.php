 ...
 */
class getMandateRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MandateRepository' shared autowired service.
     *
     * @return \App\Repository\MandateRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 5).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MandateRepository.php';

        return $container->privates['App\\Repository\\MandateRepository'] = new \App\Repository\MandateRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
