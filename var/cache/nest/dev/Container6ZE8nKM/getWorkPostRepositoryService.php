 ...
 */
class getWorkPostRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\WorkPostRepository' shared autowired service.
     *
     * @return \App\Repository\WorkPostRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 5).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'WorkPostRepository.php';

        return $container->privates['App\\Repository\\WorkPostRepository'] = new \App\Repository\WorkPostRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
