 ...
 */
class getWorkshopRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\WorkshopRepository' shared autowired service.
     *
     * @return \App\Repository\WorkshopRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 5).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'WorkshopRepository.php';

        return $container->privates['App\\Repository\\WorkshopRepository'] = new \App\Repository\WorkshopRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
