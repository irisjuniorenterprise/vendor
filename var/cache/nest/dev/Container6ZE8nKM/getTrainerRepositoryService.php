 ...
 */
class getTrainerRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TrainerRepository' shared autowired service.
     *
     * @return \App\Repository\TrainerRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 5).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TrainerRepository.php';

        return $container->privates['App\\Repository\\TrainerRepository'] = new \App\Repository\TrainerRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
