...
class getFieldRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 5).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FieldRepository.php';

        return $container->privates['App\\Repository\\FieldRepository'] = new \App\Repository\FieldRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
