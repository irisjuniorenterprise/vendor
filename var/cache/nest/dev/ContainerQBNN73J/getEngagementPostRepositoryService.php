 ...
 */
class getEngagementPostRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EngagementPostRepository' shared autowired service.
     *
     * @return \App\Repository\EngagementPostRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 5).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EngagementPostRepository.php';

        return $container->privates['App\\Repository\\EngagementPostRepository'] = new \App\Repository\EngagementPostRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
